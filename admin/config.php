<?php
// HTTP
define('HTTP_SERVER', 'http://localhost:8081/pizza/admin/');
define('HTTP_CATALOG', 'http://localhost:8081/pizza/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost:8081/pizza/admin/');
define('HTTPS_CATALOG', 'http://localhost:8081/pizza/');

define('APPLICATION', 'D:\verchigo\www\pizza');
// DIR
