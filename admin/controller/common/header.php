...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['text_registrations_not_approved'] = $this->language->get('text_registrations_not_approved');
		...
		if (!isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$data['registration_total'] = $this->model_extension_registrations->getTotalRegistrations(array('filter_approved' => false));
			$data['registrations'] = $this->url->link('extension/registrations', 'token=' . $this->session->data['token'], 'SSL');
			...
			$data['alerts'] = $customer_total + $product_total + $review_total + $return_total + $affiliate_total + $data['registration_total'];
