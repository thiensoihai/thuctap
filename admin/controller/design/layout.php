...
class ControllerDesignLayout extends Controller {
	...
	protected function getForm() {
		...
		$data['text_top_banner_sidebar'] = $this->language->get('text_top_banner_sidebar');
		$data['text_column_right_sidebar'] = $this->language->get('text_column_right_sidebar');
		$data['text_column_left_sidebar'] = $this->language->get('text_column_left_sidebar');
