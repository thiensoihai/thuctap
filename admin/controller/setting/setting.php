...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['text_tax_include_method_shipping_fee'] = $this->language->get('text_tax_include_method');
		...
		if (isset($this->request->post['tax_include_method_shipping_fee'])) {
			$data['tax_include_method_shipping_fee'] = $this->request->post['tax_include_method_shipping_fee'];
		} else {
			$data['tax_include_method_shipping_fee'] = $this->config->get('tax_include_method_shipping_fee');
		}
		...
		if (isset($this->request->post['config_background'])) {
			$data['config_background'] = $this->request->post['config_background'];
		} else {
			$data['config_background'] = $this->config->get('config_background') ? $this->config->get('config_background') : 'default.png';
		}
		
		if (isset($this->request->post['config_background_style'])) {
			$data['config_background_style'] = $this->request->post['config_background_style'];
		} else {
			$data['config_background_style'] = $this->config->get('config_background_style') ? $this->config->get('config_background_style') : 'blue';
		}		
		$data['styles'] = array('green'=>'Green color style','yellow'=>'Yellow color style','blue'=>'Blue color style');
		
		$data['backgrounds'] = array();
		$directories = DIR_CATALOG . 'view/theme/'.($data['config_template'] ? $data['config_template'] : 'default').'/image/bg/';
		$data['backgrounds'] = array_diff(scandir($directories), array('..', '.'));
		...
		if (isset($this->request->post['config_facebook_parameter'])) {
			$data['config_facebook_parameter'] = $this->request->post['config_facebook_parameter'];
		} else {
			$data['config_facebook_parameter'] = $this->config->get('config_facebook_parameter');
		}
		
		if (isset($this->request->post['config_youtube_parameter'])) {
			$data['config_youtube_parameter'] = $this->request->post['config_youtube_parameter'];
		} else {
			$data['config_youtube_parameter'] = $this->config->get('config_youtube_parameter');
		}
		
		if (isset($this->request->post['config_twitter_parameter'])) {
			$data['config_twitter_parameter'] = $this->request->post['config_twitter_parameter'];
		} else {
			$data['config_twitter_parameter'] = $this->config->get('config_twitter_parameter');
		}
		
		if (isset($this->request->post['config_googleplus_parameter'])) {
			$data['config_googleplus_parameter'] = $this->request->post['config_googleplus_parameter'];
		} else {
			$data['config_googleplus_parameter'] = $this->config->get('config_googleplus_parameter');
		}
		
		if (isset($this->request->post['config_instagram_parameter'])) {
			$data['config_instagram_parameter'] = $this->request->post['config_instagram_parameter'];
		} else {
			$data['config_instagram_parameter'] = $this->config->get('config_instagram_parameter');
		}
		
		if (isset($this->request->post['config_account_instagram_parameter'])) {
			$data['config_account_instagram_parameter'] = $this->request->post['config_account_instagram_parameter'];
		} else {
			$data['config_account_instagram_parameter'] = $this->config->get('config_account_instagram_parameter');
		}		
		
		if (isset($this->request->post['config_account_instagram_id_parameter'])) {
			$data['config_account_instagram_id_parameter'] = $this->request->post['config_account_instagram_id_parameter'];
		} else {
			$data['config_account_instagram_id_parameter'] = $this->config->get('config_account_instagram_id_parameter');
		}
		
		if (isset($this->request->post['config_token_instagram_parameter'])) {
			$data['config_token_instagram_parameter'] = $this->request->post['config_token_instagram_parameter'];
		} else {
			$data['config_token_instagram_parameter'] = $this->config->get('config_token_instagram_parameter');
		}
	...
	public function backround() {
		...
		if (is_file(DIR_CATALOG . 'view/theme/'.basename($this->request->get['template']).'/image/bg/' . basename($this->request->get['background']))) {
			$this->response->setOutput($server . 'catalog/view/theme/'.basename($this->request->get['template']).'/image/bg/' . basename($this->request->get['background']));
		} else {
			$this->response->setOutput($server . 'image/no_image.png');
		}
	}
