...
class ModelExtensionNews extends Model {
	public function addNews($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "news SET image = '" . $this->db->escape($data['image']) . "', amount_fees = '" . $this->db->escape($data['amount_fees']) . "', date_added = NOW(), status = '" . (int)$data['status'] . "', active_registration='" . (int)$data['active_registration'] . "'");
	...
	public function editNews($news_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "news SET image = '" . $this->db->escape($data['image']) . "', amount_fees = '" . $this->db->escape($data['amount_fees']) . "', status = '" . (int)$data['status'] . "', active_registration='" . (int)$data['active_registration'] . "' WHERE news_id = '" . (int)$news_id . "'");
