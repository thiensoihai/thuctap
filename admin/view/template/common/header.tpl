...
<?php } ?>
<!-- dropzone -->
<link href="view/stylesheet/dropzone.css" rel="stylesheet" />
<script src="view/javascript/dropzone.js"></script>
</head>
<body>
<div id="container">
  ...
  <ul class="nav pull-right">
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><span class="label label-danger pull-left"><?php echo $alerts; ?></span> <i class="fa fa-bell fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right alerts-dropdown">
        ...
        <li><a href="<?php echo $registrations; ?>"><span class="label label-danger pull-right"><?php echo $registration_total; ?></span><?php echo $text_registrations_not_approved; ?></a></li>
