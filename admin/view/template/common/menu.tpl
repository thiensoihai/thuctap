<ul id="menu">
  ...
  <li id="customize">
  	  <a class="parent"><i class="fa fa-cog fa-fw"></i> <span><?php echo $text_customize; ?></span></a>
  	  <ul>
	  	  <li><a href="<?php echo $social_login; ?>"><?php echo $text_customize_social_login; ?></a></li>
	  	  <li><a href="<?php echo $link_training_workshop; ?>"><?php echo $text_training_workshop; ?></a></li>
	  	  <li><a href="<?php echo $text_news; ?>"><?php echo $text_link_news; ?></a></li>
	  	  <li><a href="<?php echo $link_registrations; ?>"><?php echo $text_link_registrations; ?></a></li>
	  	  <li><a href="<?php echo $link_registrations_location; ?>"><?php echo $text_link_registrations_location; ?></a></li>
	  	  <li><a href="<?php echo $link_video; ?>"><?php echo $text_link_video; ?></a></li>
	  	  <li><a href="<?php echo $banner_home; ?>"><?php echo $text_customize_banner_home; ?></a></li>
	  	  <!--li><a href="<?php echo $banner_home_right; ?>"><?php echo $text_customize_banner_home_category_right; ?></a></li>
	  	  <li><a href="<?php echo $banner_home_left; ?>"><?php echo $text_customize_banner_home_category_left; ?></a></li-->
	  	  <li><a href="<?php echo $link_fanepage; ?>"><?php echo $text_customize_fanepage; ?></a></li>
	  	  <!--li><a href="<?php echo $link_fanepage_view; ?>"><?php echo $text_link_fanepage; ?></a></li-->
	  	  <li><a href="<?php echo $information_contents; ?>"><?php echo $text_link_contents; ?></a></li>
	  </ul>
  </li>
