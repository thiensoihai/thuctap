            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
					<?php if ($layout_module['position'] == 'content_bottom_left') { ?>
                    <option value="content_bottom_left" selected="selected"><?php echo $text_content_left; ?></option>
                    <?php } else { ?>
                    <option value="content_bottom_left"><?php echo $text_content_left; ?></option>
                    <?php } ?>
					<?php if ($layout_module['position'] == 'content_bottom_right') { ?>
                    <option value="content_bottom_right" selected="selected"><?php echo $text_content_right; ?></option>
                    <?php } else { ?>
                    <option value="content_bottom_right"><?php echo $text_content_right; ?></option>
                    <?php } ?>
                    ...
                    <?php } ?>
					<?php if ($layout_module['position'] == 'top_banner_sidebar') { ?>
                    <option value="top_banner_sidebar" selected="selected"><?php echo $text_top_banner_sidebar; ?></option>
                    <?php } else { ?>
                    <option value="top_banner_sidebar"><?php echo $text_top_banner_sidebar; ?></option>
                    <?php } ?>
					<?php if ($layout_module['position'] == 'column_left_sidebar') { ?>
                    <option value="column_left_sidebar" selected="selected"><?php echo $text_column_left_sidebar; ?></option>
                    <?php } else { ?>
                    <option value="column_left_sidebar"><?php echo $text_column_left_sidebar; ?></option>
                    <?php } ?>					
					<?php if ($layout_module['position'] == 'column_right_sidebar') { ?>
                    <option value="column_right_sidebar" selected="selected"><?php echo $text_column_right_sidebar; ?></option>
                    <?php } else { ?>
                    <option value="column_right_sidebar"><?php echo $text_column_right_sidebar; ?></option>
                    <?php } ?>
					</td>
...
function addModule() {
    ...
    html += '    <option value="content_bottom_left"><?php echo $text_content_left; ?></option>';
    html += '    <option value="content_bottom_right"><?php echo $text_content_right; ?></option>';
    html += '    <option value="column_left"><?php echo $text_column_left; ?></option>';
    html += '    <option value="column_right"><?php echo $text_column_right; ?></option>';
    html += '    <option value="top_banner_sidebar"><?php echo $text_top_banner_sidebar; ?></option>';
    html += '    <option value="column_left_sidebar"><?php echo $text_column_left_sidebar; ?></option>';
    html += '    <option value="column_right_sidebar"><?php echo $text_column_right_sidebar; ?></option>';
    html += '  </select></td>';
