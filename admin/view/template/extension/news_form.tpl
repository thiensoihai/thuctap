    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-news" class="form-horizontal">
		  ...
		  <div class="form-group">
			<label class="col-sm-2 control-label" for="input-amount_fees"><?php echo $text_amount_fees; ?></label>
			<div class="col-sm-10">
			  <input type="text" name="amount_fees" value="<?php echo $amount_fees; ?>" placeholder="<?php echo $text_amount_fees; ?>" id="input-amount_fees" class="form-control" />
			</div>
		  </div>
		  <div class="form-group">
		 ...
		 <div class="form-group">
			<label class="col-sm-2 control-label" for="input-active_registration">Active Registrations</label>
			<div class="col-sm-10">
			  <select name="active_registration" id="input-status" class="form-control">
