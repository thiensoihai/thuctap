            ...
            <table class="table table-bordered table-striped table-hover">
			  <thead>
				<tr>
				  ...
				  <td class="text-right"><?php echo $text_amount_fees; ?></td>
			  ...
			  <tbody>
				<?php if ($all_news) { ?>
				  ...
				  <tr>
					...
					<td class="text-right"><?php echo $news['amount_fees']; ?></td>
					<td class="text-left"><?php echo $news['short_description']; ?></td>
					<td class="text-left"><?php echo $news['active_registration']; ?></td>
					<td class="text-left"><?php echo $news['date_added']; ?></td>
					<td class="text-right"> <a href="<?php echo $news['edit']; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a> </td>
				  </tr>
				  <?php } ?>
				<?php } else { ?>
				  <tr>
