  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-video" class="form-horizontal">
            ...
            <table class="table table-bordered table-striped table-hover">
			  ...
			  <tbody>
				<?php if ($all_video) { ?>
				  ...
				  <tr>
					<td width="1" style="text-align: center;"><input type="checkbox" name="selected[]" value="<?php echo $video['video_id']; ?>" /></td>
					<td class="text-left"><?php echo $video['title']; ?></td>
					<td class="text-left"><?php echo $video['short_description']; ?></td>
					<td class="text-left"><?php echo $video['date_added']; ?></td>
					<td class="text-right"> <a href="<?php echo $video['edit']; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a> </td>
				  </tr>
				  <?php } ?>
				<?php } else { ?>
				  <tr>
