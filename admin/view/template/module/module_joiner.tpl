      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-slider" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_row_wise; ?>"><?php echo $entry_row_wise; ?></span></label>
            <div class="col-sm-10">
				<label class="radio-inline">
                    <?php if ($row_wise) { ?>
                    <input type="radio" name="row_wise" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="row_wise" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                </label>
				<label class="radio-inline">
                    <?php if (!$row_wise) { ?>
                    <input type="radio" name="row_wise" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="row_wise" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                </label>
            </div>
          ...
          <table id="module" class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                ...
                <td class="text-left"><span data-toggle="tooltip" title="<?php echo $help_weightage; ?>"><?php echo $entry_weightage; ?></span></td>
            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-right"><input type="text" name="layout_module[<?php echo $module_row; ?>][weightage]" value="<?php echo $layout_module['weightage']; ?>" placeholder="<?php echo $entry_weightage; ?>" class="form-control" /></td>
...
function addModule() {
	...
	<?php } ?>
    html += '  </select></td>';
	html += '  <td class="text-left"><input type="text" name="layout_module[' + module_row + '][weightage]" value="" placeholder="<?php echo $entry_weightage; ?>" class="form-control" /></td>';
