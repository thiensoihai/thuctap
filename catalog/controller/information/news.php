	...
	public function index() {
		...
		foreach ($all_news as $news) {
			$data['all_news'][] = array (
				...
				'amount_fees' 	=> $this->currency->format($news['amount_fees']),
				'image'			=> $this->model_tool_image->resize($news['image'], 100, 100),
				'description' 	=> html_entity_decode($news['short_description'], ENT_QUOTES),
				'content' 		=> html_entity_decode($news['description'], ENT_QUOTES),
				'view' 			=> $this->url->link('information/news/news', 'news_id=' . $news['news_id']),
				'register_link'	=> ($news['active_registration']==1) ? $this->url->link('account/registerform').'/'.$news['news_id'] : '',
