	...
	public function index() {
		...
		foreach ($categories as $category) {
			...
			$data['categories'][] = array(
				...
				'href'        => $this->url->link('product/category', 'path=' .(isset($category_info['category_id']) ? $category_info['category_id'].'_'.$category['category_id'] : $category['category_id']))
			);
		}
		$data['menu_main'] = $category_info;
