...
$(document).ready(function() {
	...
	/* Search */
	$('.search-box').find('button').on('click', function() {
	...
	$('.search-box input[name=\'search\']').on('keydown', function(e) {
		if (e.keyCode == 13) {
			...
			window.location.href = url+'&search='+escape($(this).val());			
		}
	});
	...
	$(document).on('click', '.minus', function() {
		...
		if(quantity > 1)
		{
			var totalqty = parseInt(quantity) - 1;
			$('.quantity .qty').val(totalqty)
		}
	});
