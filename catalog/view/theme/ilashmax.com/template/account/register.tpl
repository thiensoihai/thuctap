      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-firstname"><?php echo $entry_firstname; ?><span class="required_field">*</span></label>
            <div class="col-sm-9">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-lastname"><?php echo $entry_lastname; ?><span class="required_field">*</span></label>
            <div class="col-sm-9">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-email"><?php echo $entry_email; ?><span class="required_field">*</span></label>
            <div class="col-sm-9">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-telephone"><?php echo $entry_telephone; ?><span class="required_field">*</span></label>
            <div class="col-sm-9">
        ...
        <fieldset id="address">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-address-1"><?php echo $entry_address_1; ?><span class="required_field">*</span></label>
            <div class="col-sm-9">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-city"><?php echo $entry_city; ?><span class="required_field">*</span></label>
            <div class="col-sm-9">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-postcode"><?php echo $entry_postcode; ?><span class="required_field">*</span></label>
            <div class="col-sm-9">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-country"><?php echo $entry_country; ?><span class="required_field">*</span></label>
            <div class="col-sm-9">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-zone"><?php echo $entry_zone; ?><span class="required_field">*</span></label>
            <div class="col-sm-9">
        ...
        <fieldset>
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-password"><?php echo $entry_password; ?><span class="required_field">*</span></label>
            <div class="col-sm-9">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-confirm"><?php echo $entry_confirm; ?><span class="required_field">*</span></label>
            <div class="col-sm-9">
