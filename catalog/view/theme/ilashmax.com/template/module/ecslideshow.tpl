	                ...
	                <div class="camera_caption <?php echo $caption_effect;?> <?php echo $caption_class;?>">
	                    ...
	                    <div class="cartinfo">
							...
							<div class="button-group">
				                <button type="button" class="button button-rounded button-reveal button-large button-yellow button-light" onclick="cart.add('<?php echo $slide['product_id']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span></button>
				            </div>
	                    </div>
	                	<?php endif; ?>
	                </div>
