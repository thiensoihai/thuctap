    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>     
      <div class="google-map">
        <div class="panel-body col-sm-5">
          <div class="row">
            <?php if ($image) { ?>
            <div class="col-sm-12"><img src="<?php echo $image; ?>" alt="<?php echo $store; ?>" title="<?php echo $store; ?>" class="img-thumbnail" style="border: 0;margin-bottom: 20px;" /></div>
            <?php } ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-8">
              <textarea name="enquiry" rows="4" id="input-enquiry" class="form-control"><?php echo $enquiry; ?></textarea>
