...
class ControllerCatalogProduct extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->request->post['date_available'] = $this->convertDateToDate($this->request->post['date_available'],TRUE);
	...
	private function convertDateToDate($dateString,$action=FALSE)
	{
		if($action==FALSE)
		{
	...
	protected function getForm() {
		...
		if (isset($this->request->post['date_available'])) {
			$data['date_available'] = $this->convertDateToDate($this->request->post['date_available']);
		} elseif (!empty($product_info)) {
			$data['date_available'] = ($product_info['date_available'] != '00/00/0000') ? $this->convertDateToDate($product_info['date_available']) : '';
		} else {
			$data['date_available'] = date('m/d/Y',strtotime('-1 day'));
		}
