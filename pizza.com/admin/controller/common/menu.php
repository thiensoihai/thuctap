...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_customize_social_login'] = $this->language->get('text_customize_social_login');
		$data['text_customize_banner_home'] = $this->language->get('text_customize_banner_home');
		$data['text_customize_banner_home_category_right'] = $this->language->get('text_customize_banner_home_category_right');
		$data['text_customize_banner_home_category_left'] = $this->language->get('text_customize_banner_home_category_left');
		$data['text_customize_fanepage'] = $this->language->get('text_customize_fanepage');
		$data['text_link_fanepage'] = $this->language->get('text_link_fanepage');
		$data['text_link_contents'] = $this->language->get('text_link_contents');
		$data['text_link_news'] = $this->language->get('text_link_news');
		$data['text_link_video'] = $this->language->get('text_link_video');
		$data['text_training_workshop'] = $this->language->get('text_training_workshop');
		$data['text_link_registrations'] = $this->language->get('text_link_registrations');
		$data['text_link_registrations_location'] = $this->language->get('text_link_registrations_location');

		$data['link_training_workshop'] = $this->url->link('module/html', 'token=' . $this->session->data['token'].'&module_id=48', 'SSL');
		$data['link_video'] = $this->url->link('extension/video', 'token=' . $this->session->data['token'], 'SSL');
		$data['text_news'] = $this->url->link('extension/news', 'token=' . $this->session->data['token'], 'SSL');
		$data['social_login'] = $this->url->link('module/social_login_free', 'token=' . $this->session->data['token'], 'SSL');
		$data['banner_home'] = $this->url->link('design/banner', 'token=' . $this->session->data['token'], 'SSL');
		$data['banner_home_right'] = $this->url->link('module/fcategory', 'token=' . $this->session->data['token'].'&module_id=41', 'SSL');
		$data['banner_home_left'] = $this->url->link('module/featuredCategory', 'token=' . $this->session->data['token'].'&module_id=42', 'SSL');
		$data['link_fanepage'] = $this->url->link('module/html', 'token=' . $this->session->data['token'].'&module_id=47', 'SSL');
		$data['link_fanepage_view'] = $this->url->link('module/hok_sharing', 'token=' . $this->session->data['token'].'&module_id=44', 'SSL');
		$data['information_contents'] = $this->url->link('catalog/information', 'token=' . $this->session->data['token'], 'SSL');
		$data['link_registrations'] = $this->url->link('extension/registrations', 'token=' . $this->session->data['token'], 'SSL');
		$data['link_registrations_location'] = $this->url->link('extension/location', 'token=' . $this->session->data['token'], 'SSL');
