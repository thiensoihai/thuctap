...
class ControllerExtensionNews extends Controller {
	...
	public function index() {
		...
		$data['text_amount_fees'] = $this->language->get('text_amount_fees');
		...
		foreach ($all_news as $news) {
			...
			$data['all_news'][] = array (
				...
				'title' 			=> $news['title'],
				'amount_fees' 		=> $news['amount_fees'],
				'short_description'	=> $news['short_description'],
				'active_registration'	=> ($news['active_registration'] ? $this->language->get('text_enabled') : $this->language->get('text_disabled')),
	...
	protected function form() {
		...
		if (isset($this->request->post['amount_fees'])) {
			$data['keyword'] = $this->request->post['amount_fees'];
		} elseif (!empty($news)) {
			$data['amount_fees'] = $news['amount_fees'];
		} else {
			$data['amount_fees'] = '';
		}
		...
		if (isset($this->request->post['active_registration'])) {
			$data['active_registration'] = $this->request->post['active_registration'];
		} elseif (!empty($news)) {
			$data['active_registration'] = $news['active_registration'];
		} else {
			$data['active_registration'] = '';
		}
