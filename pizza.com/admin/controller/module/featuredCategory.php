...
class ControllerModuleFeaturedCategory extends Controller {
	...
	public function index() {
        ...
        $data['entry_description_status'] = $this->language->get('entry_description_status');
		...
		if (isset($this->request->post['description_status'])) {
			...
			$data['description_status'] = $module_info['description_status'];
		} else {
