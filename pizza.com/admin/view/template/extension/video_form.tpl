    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-video" class="form-horizontal">
		  ...
		  <div class="tab-content">
			...
			<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
			  <div class="form-group required">
				...
				<div class="col-sm-10">
				  <input type="text" name="video[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($video[$language['language_id']]) ? $video[$language['language_id']]['title'] : ''; ?>" placeholder="<?php echo $text_title; ?>" id="input-title<?php echo $language['language_id']; ?>" class="form-control" />
				</div>
			  </div>
			  <div class="form-group required">
				<label class="col-sm-2 control-label" for="input-short<?php echo $language['language_id']; ?>"><?php echo $text_short_description; ?></label>
				<div class="col-sm-10">
				  <textarea name="video[<?php echo $language['language_id']; ?>][short_description]" rows="5" placeholder="<?php echo $text_short_description; ?>" id="input-short<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($video[$language['language_id']]) ? $video[$language['language_id']]['short_description'] : ''; ?></textarea>
				</div>
			  </div>
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <textarea name="video[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $text_description; ?>" id="input-description<?php echo $language['language_id']; ?>"><?php echo isset($video[$language['language_id']]) ? $video[$language['language_id']]['description'] : ''; ?></textarea>
				</div>
			  </div>
			</div>
			<?php } ?>
		  ...
		  <div class="form-group">
			<label class="col-sm-2 control-label" for="input-keyword"><?php echo $text_youtube; ?></label>
			<div class="col-sm-10">
			  <input type="text" name="youtube" value="<?php echo $youtube; ?>" placeholder="<?php echo $text_youtube; ?>" id="input-keyword" class="form-control" />
			</div>
		  </div> 
		  <div class="form-group">
