              ...
              <div class="tab-content">
                <div id="setting_basic" class="tab-pane active">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <select name="social_login_free_status" id="input_status" class="form-control">
                          <?php if ($social_login_free_status) { ?>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="well well-sm clearfix sort-item">
                            <div class="row">
                              <div class="col-sm-3">
                              <span for="social_login_free_modules_providers_<?php echo $key; ?>_enabled">
