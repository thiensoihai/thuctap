          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
			  ...
			  <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="config_background" id="input-background" class="form-control">
                    <?php foreach ($backgrounds as $background) { ?>
                    <?php if ($background == $config_background) { ?>
                    <option value="<?php echo $background; ?>" selected="selected"><?php echo $background; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $background; ?>"><?php echo $background; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                  <br />
                  <img src="" alt="" id="background" class="img-thumbnail" width="250" /></div>
              </div>
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-background_style"><?php echo $entry_background_style; ?></label>
                <div class="col-sm-10">
                  <select name="config_background_style" id="input-background_style" class="form-control">
                    <?php foreach ($styles as $key=>$style) { ?>
                    <?php if ($key == $config_background_style) { ?>
                    <option value="<?php echo $key; ?>" selected="selected"><?php echo $style; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $key; ?>"><?php echo $style; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>              
				 </div>              	
            ...
            <div class="tab-pane" id="tab-option">
              ...
              <fieldset>
				...
				<div class="form-group">
                  <label class="col-sm-2 control-label"><?php echo $text_tax_include_method_shipping_fee; ?></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($tax_include_method_shipping_fee) { ?>
                      <input type="radio" name="tax_include_method_shipping_fee" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="tax_include_method_shipping_fee" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$tax_include_method_shipping_fee) { ?>
                      <input type="radio" name="tax_include_method_shipping_fee" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="tax_include_method_shipping_fee" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
			...
			<div id="tab-social"  class="tab-pane">
				<div class="form-group">
	                <label class="col-sm-2 control-label" for="input-facebook-parameter"><span data-toggle="tooltip" title="Link to Facebook">Face Book</span></label>
	                <div class="col-sm-10">
	                  <input type="text" name="config_facebook_parameter" value="<?php echo $config_facebook_parameter; ?>" placeholder="Link to Facebook" id="input-facebook-parameter" class="form-control" />
	                </div>
	            </div>
				<div class="form-group">
	                <label class="col-sm-2 control-label" for="input-youtube-parameter"><span data-toggle="tooltip" title="Link to Facebook">Youtube</span></label>
	                <div class="col-sm-10">
	                  <input type="text" name="config_youtube_parameter" value="<?php echo $config_youtube_parameter; ?>" placeholder="Link to Youtube" id="input-youtube-parameter" class="form-control" />
	                </div>
	            </div>
				<div class="form-group">
	                <label class="col-sm-2 control-label" for="input-twitter-parameter"><span data-toggle="tooltip" title="Link to Facebook">Twitter</span></label>
	                <div class="col-sm-10">
	                  <input type="text" name="config_twitter_parameter" value="<?php echo $config_twitter_parameter; ?>" placeholder="Link to Twitter" id="input-twitter-parameter" class="form-control" />
	                </div>
	            </div>
				<div class="form-group">
	                <label class="col-sm-2 control-label" for="input-googleplus-parameter"><span data-toggle="tooltip" title="Link to Facebook">Google Plus</span></label>
	                <div class="col-sm-10">
	                  <input type="text" name="config_googleplus_parameter" value="<?php echo $config_googleplus_parameter; ?>" placeholder="Link to Google Plus" id="input-googleplus-parameter" class="form-control" />
	                </div>
	            </div>
				<div class="form-group">
	                <label class="col-sm-2 control-label" for="input-instagram-parameter"><span data-toggle="tooltip" title="Link to Instagram">Instagram</span></label>
	                <div class="col-sm-10">
	                  <input type="text" name="config_instagram_parameter" value="<?php echo $config_instagram_parameter; ?>" placeholder="Link to Instagram" id="input-instagram-parameter" class="form-control" />
	                </div>
	            </div>
				<div class="form-group">
	                <label class="col-sm-2 control-label" for="input-account-instagram-parameter"><span data-toggle="tooltip" title="Link to Instagram">Account Instagram</span></label>
	                <div class="col-sm-10">
	                  <input type="text" name="config_account_instagram_parameter" value="<?php echo $config_account_instagram_parameter; ?>" placeholder="Account Instagram" id="input-account-instagram-parameter" class="form-control" />
	                </div>
	            </div>
				<div class="form-group">
	                <label class="col-sm-2 control-label" for="input-account-instagram-parameter"><span data-toggle="tooltip" title="User Instagram ID">User Instagram ID</span></label>
	                <div class="col-sm-10">
	                  <input type="text" name="config_account_instagram_id_parameter" value="<?php echo $config_account_instagram_id_parameter; ?>" placeholder="Account Instagram ID" id="input-account-instagram-parameter" class="form-control" />
	                </div>
	            </div>
				<div class="form-group">
	                <label class="col-sm-2 control-label" for="input-token-instagram-parameter"><span data-toggle="tooltip" title="User Instagram ID">Instagram Token</span></label>
	                <div class="col-sm-10">
	                  <input type="text" name="config_token_instagram_parameter" value="<?php echo $config_token_instagram_parameter; ?>" placeholder="Instagram Token" id="input-token-instagram-parameter" class="form-control" />
	                </div>
	            </div>
			</div>
          </div>
...
$('select[name=\'config_background\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=setting/setting/backround&token=<?php echo $token; ?>&template=' + encodeURIComponent($('#input-template').val())+'&background='+encodeURIComponent(this.value),
		dataType: 'html',
		beforeSend: function() {
			$('select[name=\'country_id\']').after(' <i class="fa fa-circle-o-notch fa-spin"></i>');
		},
...
$('select[name=\'config_background\']').trigger('change');
