...
function ($) { "use strict"; 
  ...
  Pongstgrm.defaults = {
    ...
    // ===========================
    , preload:          "spinner"
    , button:           "btn btn-success pull-right rightmargin-lg topmargin"
    , buttontext:       "Load More"
    , column:           "col-xs-12 col-sm-3 col-md-2 col-lg-2 norightpadding 10leftpadding"
  ...
  Pongstgrm.prototype.template = {
    ...
    , profile: function (options) {
        var _profile  = '<div class="pongstgrm-profile">'
            ...
            _profile += '     <p><a href="https://www.instagram.com/'+options.username+'" target="_blank"><strong>'+options.username+'</strong></a></p>'
            _profile += '   </div>'
            _profile += '   <div class="user-data">'
            _profile += '     <a href="https://www.instagram.com/'+options.username+'" target="_blank"><strong>Follow</strong></a>'
    ...
    , thumb: function (options) {
		if(options.dflt.column)	number+=1;
		var nopaddingright = (number%6==0) ? ' l-norightpadding' : '';
		 //console.log(options);
        var _thumbnail  = '<div class="'+ options.dflt.column + nopaddingright +'">'
    ...
    function paginate (option) {
      (option.url === undefined || option.url === null) ? 
        $('[data-paginate='+ option.show +']').on('click', function (e) {
            $(this)
              .removeClass()
              .addClass('btn btn-default pull-right rightmargin-lg topmargin')
