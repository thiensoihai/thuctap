...
<div id="menuContainer">
    <div class="container">
        <ul class="mainMenu" id="nav">
            ...
            <li>
                <div class="dropdown">
                    <a href="<?php echo $product?>" type="button" id="dropdownMenu1">
                        Menu
                    </a>
                    <ul style="z-index:100" class="dropmenu">
        ...
        <!-- id="bkTable"-->
        <div class="login"><a href="<?php echo $checkout?>" class="bookTable">Book a table</a>
            <ul>
